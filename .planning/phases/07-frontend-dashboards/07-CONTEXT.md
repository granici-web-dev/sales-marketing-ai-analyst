...
- `backend/app/schemas/insights/daily_insight_schema.py` — DailyInsightResponse (problems, summary_ro, etc.)
...
- **YoY overlay toggle** — mentioned by user as a preset shortcut option; deferred to Phase 9 polish (not in ROADMAP Phase 7 SC).
