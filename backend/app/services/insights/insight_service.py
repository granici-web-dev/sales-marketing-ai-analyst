...
class InsightService:
    ...
    async def _fetch_kpi_snapshot(self, kpi_date: date) -> dict | None:
        ...
        return {
            ...
            "contracts_closed": row.contracts_count,
            ...
            "wow_delta_pct": row.conversion_l_to_c_wow_delta,
            "mom_delta_pct": row.conversion_l_to_c_mom_delta,
        }
