...
class TestBusinessMinutesBetween:
    ...
    def test_lead_created_inside_hours_first_touch_same_window(self) -> None:
        ...
        result = business_minutes_between(start_utc, end_utc, OPEN_TIME, CLOSE_TIME, WORK_DAYS)
        assert result == 30, (
    ...
    def test_full_day_inside_hours(self) -> None:
        ...
        result = business_minutes_between(start_utc, end_utc, OPEN_TIME, CLOSE_TIME, WORK_DAYS)
        assert result == 600, f"09:00 to 19:00 (full business day) → 600 minutes, got {result}"
