...
> Этот файл — главная точка входа для Claude Code в этом проекте.
...
3. Раз в день генерирует AI-инсайты через Claude Sonnet 4.5 с планом действий на румынском
...
- ❌ Не вызывать Claude API из HTTP-handler'ов (только из Celery tasks)
...
- [Claude Sonnet 4.5 model card](https://docs.claude.com/en/docs/about-claude/models)
